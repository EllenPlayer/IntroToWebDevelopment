...
}// Alternative could have used numbers.sort(function(a, b){return b-a}); or  function myArrayMax(arr) {   var len = arr.length;  var max = -Infinity;  while (len--) {    if (arr[len] > max) {      max = arr[len];    }  }  return max;}
//var actual = findMax(numbers);
//console.log("The maximum number is: %s",actual);
...
}// Could have probs used concat as well or loop to push onto a new array as long as i was less than the length
